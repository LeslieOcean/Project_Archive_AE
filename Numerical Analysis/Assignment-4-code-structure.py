...
x0 =  # domain corner, x coordinate
y0 =  # domain corner, y coordinate
Lx =  # domain extent in x-direction
Ly =  # domain extent in y-direction
T =  # time interval
As =  # source magnitude
alpha =  # source decay rate in space
B =  # wind constant
D =  # diffusivity constant
bcValue =  # Dirichlet BC value
